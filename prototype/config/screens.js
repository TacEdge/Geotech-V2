...
window.TE_SCREENS = [
  {
    ...
    group: 'define-job',
    cardTitle: 'Projects',
    desc: 'Create projects, clients and engineers.'
  },
  {
    id: 'platform',
    ...
    header:
      '<header class="topbar">\n    <a class="burger" href="../index.html" aria-label="All screens" title="All screens"><span></span><span></span><span></span></a>\n    <img class="logo" src="../assets/brand/tacedge-logo.png" alt="TACEDGE">\n    <span class="vert"></span>\n    <span class="tag">Ground Engineering</span>\n    <div class="right"><span class="who"><span class="av">TR</span>Tim R · PM</span></div>\n  </header>',
    icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3.4"/><path d="M12 3.5v2.3M12 18.2v2.3M3.5 12h2.3M18.2 12h2.3M6 6l1.6 1.6M16.4 16.4L18 18M18 6l-1.6 1.6M7.6 16.4L6 18"/></svg>',
    eyebrow: 'PLATFORM EXPLAINER',
    cardTitle: 'The configurable engine',
  ...
  },
  {
    ...
    header:
      '<header class="topbar">\n  {{CONTOUR:desktop}}\n  <a class="burger" href="../index.html" aria-label="All screens" title="All screens"><span></span><span></span><span></span></a>\n  <div class="brand"><img class="wordmark-img" src="../assets/brand/tacedge-lockup-cream.svg" alt="TACEDGE"><span class="vert"></span><span class="tag">Ground Engineering</span></div>\n  <div class="proj"><span class="name">Benmore Dam – Spillway Anchoring</span><span class="meta">Groundline Civil · Meridian Energy · WSP engineer · Setup</span></div>\n  <div class="right"><span class="sync"><span class="dot"></span>Synced 2 min ago</span><span class="who"><span class="av">TR</span>Tim R · PM <span class="car">&#9662;</span></span></div>\n</header>',
  ...
  },
  {
    ...
    cardTitle: 'Work Item Template',
    desc: 'Set reusable work item templates.'
  },
  {
    ...
    desc: 'Set acceptance criteria once.'
  },
  {
    id: 'evidence-qa',
    ...
    group: 'define-work',
    cardTitle: 'Evidence Requirements',
  ...
  },
  {
    ...
    group: 'define-work',
    cardTitle: 'Work Plan',
    desc: 'Place and commit the work items.'
  },
  {
    ...
    desc: 'Gate field sign-on with JSA and SWMS.'
  },
  {
    id: 'team-publish',
    title: 'Team & Publish',
    ...
    desc: 'Assign roles and publish to the field.'
  },
  {
    id: 'overview',
    title: 'Overview',
    ...
    header:
      '<header class="topbar">\n  {{CONTOUR:desktop}}\n  <a class="burger" href="../index.html" aria-label="All screens" title="All screens"><span></span><span></span><span></span></a>\n  <div class="brand"><img class="wordmark-img" src="../assets/brand/tacedge-lockup-cream.svg" alt="TACEDGE"><span class="vert"></span><span class="tag">Ground Engineering</span></div>\n  <div class="proj"><span class="name">Benmore Dam – Spillway Anchoring</span><span class="meta">Groundline Civil · Meridian Energy · WSP engineer</span></div>\n  <div class="right"><span class="sync"><span class="dot"></span>Synced 2 min ago</span><span class="who"><span class="av">TR</span>Tim R · PM <span class="car">&#9662;</span></span></div>\n</header>',
  ...
  },
  {
    ...
    workTypes: ['piling'],
    header:
      '<header class="bar">\n      {{CONTOUR:field}}\n      <a class="iconbtn" href="../index.html" aria-label="Back to home" title="Back to home"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 18l-6-6 6-6"/></svg></a>\n      <div class="ctx"><span class="p">Cashmere Ridge · Screw Piling</span><span class="z">Groundline Civil · today</span></div>\n      <div class="right"><span class="fresh"><span class="d"></span>Live</span>\n        <span class="av">SK</span>\n      </div>\n    </header>',
  ...
  },
  {
    ...
    workTypes: ['rockfall'],
    header:
      '<header class="bar">\n      {{CONTOUR:field}}\n      <a class="iconbtn" href="../index.html" aria-label="Back to home" title="Back to home"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 18l-6-6 6-6"/></svg></a>\n      <div class="ctx"><span class="p">Coastal Corridor · Rockfall</span><span class="z">Groundline Civil · today</span></div>\n      <div class="right"><span class="fresh"><span class="d"></span>Live</span>\n        <span class="av">SK</span>\n      </div>\n    </header>',
  ...
  },
  {
    ...
    workTypes: ['shotcrete'],
    header:
      '<header class="bar">\n      {{CONTOUR:field}}\n      <a class="iconbtn" href="../index.html" aria-label="Back to home" title="Back to home"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 18l-6-6 6-6"/></svg></a>\n      <div class="ctx"><span class="p">Quarry Face · Shotcrete</span><span class="z">Groundline Civil · today</span></div>\n      <div class="right"><span class="fresh"><span class="d"></span>Live</span>\n        <span class="av">JN</span>\n      </div>\n    </header>',
  ...
  },
  {
    ...
    workTypes: ['drilling'],
    header:
      '<header class="bar">\n      {{CONTOUR:field}}\n      <a class="iconbtn" href="../index.html" aria-label="Back to home" title="Back to home"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 18l-6-6 6-6"/></svg></a>\n      <div class="ctx"><span class="p">Slip Site · Drilling</span><span class="z">Groundline Civil · today</span></div>\n      <div class="right"><span class="fresh"><span class="d"></span>Live</span>\n        <span class="av">PR</span>\n      </div>\n    </header>',
  ...
  },
  {
    ...
    workTypes: ['drainage'],
    header:
      '<header class="bar">\n      {{CONTOUR:field}}\n      <a class="iconbtn" href="../index.html" aria-label="Back to home" title="Back to home"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 18l-6-6 6-6"/></svg></a>\n      <div class="ctx"><span class="p">Terrace Slip · Drainage</span><span class="z">Groundline Civil · today</span></div>\n      <div class="right"><span class="fresh"><span class="d"></span>Live</span>\n        <span class="av">SK</span>\n      </div>\n    </header>',
