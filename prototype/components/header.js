...
window.TE_HEADER = (function () {
  ...
  function fill(id) {
    ...
    var html = s.header.replace(/\{\{CONTOUR:(\w+)\}\}/g, function (_, k) { return CONTOURS[k] || ''; });
